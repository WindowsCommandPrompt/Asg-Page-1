//JAVASCRIPT DOCUMENT FOR PERSONAL ACHIEVEMENTS PAGE. 
...
function ConfirmationRedirectLinkedInProfile(){
  var UserInputRedirectLinkedInProfile = confirm("You are about to be redirected to another page (Contact Card page) where you will be viewing my LinkedIn Profile. Are you sure you want to continue?");
...
function ConfirmationRedirectIGProfile(){
  var UserInputRedirectIGProfile = confirm("You are about to be redirected to another page (Contact Card page) where you will be viewing my IG Profile. Are you sure you want to continue?");
...
var buttonEnlarge5 = document.getElementById("enlarge4");
var closeButton5 = document.getElementById("closeImage4")
var targetImage5 = document.getElementById("ShowImage4")
buttonEnlarge5.addEventListener("click", function(){
  if (targetImage5.style.display == "none"){
    targetImage5.style.display = "block"
  }
  else {
    targetImage5.style.display = "none"
  }
})

closeButton5.addEventListener("click", function(){
  if (targetImage5.style.display == "block"){
    targetImage5.style.display = "none"
  }
  else {
    targetImage5.style.display = "block"
...
var buttonEnlarge6 = document.getElementById("enlarge5");
var closeButton6 = document.getElementById("closeImage5")
var targetImage6 = document.getElementById("ShowImage5")
buttonEnlarge6.addEventListener("click", function(){
  if (targetImage6.style.display == "none"){
    targetImage6.style.display = "block"
  }
  else {
    targetImage6.style.display = "none"
  }
})

closeButton6.addEventListener("click", function(){
  if (targetImage6.style.display == "block"){
    targetImage6.style.display = "none"
  }
  else {
    targetImage6.style.display = "block"
...
//if the navigationBar is not open, then stretch the article. Hide the navigation bar when the cursor leaves the navigation bar. 

//enlarged image window must close. 
...
var enlargedImage4 = document.getElementById("ShowImage4");
var enlargedImage5 = document.getElementById("ShowImage5");
...
ScreenWidthChecker.addListener(Control5); 
ScreenWidthChecker.addListener(Control6); 
...
function Control5(){
  if (ScreenWidthChecker.matches && enlargedImage4.style.display == "block"){
    enlargedImage4.style.display = "none";
  }
}

function Control6(){
  if (ScreenWidthChecker.matches && enlargedImage5.style.display == "block"){
    enlargedImage5.style.display = "none";
  }
}

//Disable Enlarge image if the viewer tries to view the enlarged image on a tablet-like monitor. 
...
//Prevent disabled buttons from re enabling when refreshing the page. 
window.addEventListener("load", (event) => {
  if (ScreenWidthChecker.matches){ //if width less than 1100px
    ...
    //Changing of the cursor only applies to desktop viewers who attempt to reduce width of webpage to less than 1100px. (viewing a mobile version of the webpage on a desktop)
    ...
    buttonEnlarge5.style.opacity = 0.5;
    buttonEnlarge5.style.cursor = "not-allowed"
    buttonEnlarge6.disabled = true;
    buttonEnlarge6.style.opacity = 0.5;
    buttonEnlarge6.style.cursor = "not-allowed"
  }
    ...
    buttonEnlarge5.disabled = false;
    buttonEnlarge5.style.opacity = 1;
    buttonEnlarge5.style.cursor = "pointer";
    buttonEnlarge6.disabled = false; 
    buttonEnlarge6.style.opacity = 1;
    buttonEnlarge6.style.cursor = "pointer";
  }
})
